...
public class LikeService {
	...
	public boolean toggleLike(Long boardId, Long memberId) {
		Optional<Like> existingLike = likeRepository.findLikeByBoardAndMember(boardId, memberId);

		
		// 있으면 삭제
		if (existingLike.isPresent()) {
			likeRepository.deleteLikeByBoardAndMember(boardId, memberId);
			return false;
		} 
	...
	public Long getLikeCount(Long boardId) {
		return likeRepository.countLikesByBoardId(boardId);
	}
